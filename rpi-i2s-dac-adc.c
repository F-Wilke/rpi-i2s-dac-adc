...
static struct snd_soc_dai_link snd_rpi_i2s_dac_adc_dai[] = {
	{
		.name           = "TeKaDe rpi_i2s_dac_adc",
		.stream_name    = "TeKaDe rpi_i2s_dac_adc stream",
		.dai_fmt        = SND_SOC_DAIFMT_I2S |
					SND_SOC_DAIFMT_NB_NF |
					SND_SOC_DAIFMT_CBS_CFS,
		SND_SOC_DAILINK_REG(rpi_i2s_dac_adc),
	},
};

static struct snd_rpi_simple_drvdata drvdata_rpi_i2s_dac_adc = {
	.card_name = "snd_rpi_i2s_dac_adc",
	.dai       = snd_rpi_i2s_dac_adc_dai,
};
...
static struct platform_driver snd_rpi_i2s_dac_adc_driver = {
	.driver = {
		.name   = "rpi-i2s-dac-adc-drv",
		.owner  = THIS_MODULE,
		.of_match_table = snd_rpi_i2s_dac_adc_of_match,
	},
